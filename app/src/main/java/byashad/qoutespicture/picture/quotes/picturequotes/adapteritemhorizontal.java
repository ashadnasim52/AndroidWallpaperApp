...
public class adapteritemhorizontal extends RecyclerView.Adapter<adapteritemhorizontal.exampleviewholder> {
    ...
    public adapteritemhorizontal(ArrayList<String> arrayList, Context mcontext) {
    ...
    public exampleviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(mcontext).inflate(R.layout.sampleitemvertical,parent,false);
